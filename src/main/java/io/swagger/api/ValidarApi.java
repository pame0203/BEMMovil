...
@Api(description = "the Validar API")
...
public class ValidarApi  {
    ...
    @GET
    @Path("/Horario/{idServicio}/{perfilUsuario}")
    @Consumes({ "*/*" })
    ...
    public Response validarHorario(@PathParam("idServicio") Long idServicio,@PathParam("perfilUsuario") Long perfilUsuario,@HeaderParam("sesion") String sesion,@HeaderParam("idSesionH") String idSesionH,@HeaderParam("dispositivo") String dispositivo,@HeaderParam("plataforma") String plataforma,@HeaderParam("nombreUsuario") String nombreUsuario,@HeaderParam("sic") String sic,@HeaderParam("version") String version) {
